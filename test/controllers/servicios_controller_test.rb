...
class ServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servicio" do
    assert_difference("Servicio.count") do
      post servicios_url, params: { servicio: { fecha: @servicio.fecha, kilometraje: @servicio.kilometraje, nom_mecanico: @servicio.nom_mecanico, unidad_id: @servicio.unidad_id } }
    end
  ...
  test "should update servicio" do
    patch servicio_url(@servicio), params: { servicio: { fecha: @servicio.fecha, kilometraje: @servicio.kilometraje, nom_mecanico: @servicio.nom_mecanico, unidad_id: @servicio.unidad_id } }
